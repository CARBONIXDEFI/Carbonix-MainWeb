            ...
            <Container>
                ...
                <Row className="justify-content-between text-center roadmap-row">
                    ...
                    <Col md={'auto'} xs={12} className="mb-4" data-aos="fade-up" data-aos-delay="300">
                        <div className="roadmap-info">
                            ...
                            <p>Setup Social Platform <br />Deploy TestNet <br />Certik Audit <br />Digital Marketing <br />Public Sale <br />Deploy Smart Contracts <br />Token Generation</p>
                        </div>
                    </Col>
                </Row>
                <Row className="justify-content-center text-center">
                    ...
                    <Col md={5} xs={12} className="mb-4" data-aos="fade-up" data-aos-delay="200">
                        <div className="roadmap-info">
                            <div className="number_circle">Q1<br /> 2022</div>
