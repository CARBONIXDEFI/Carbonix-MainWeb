...
import { BsctestnetNetwork } from 'networks/bsctestnet';
...
const networks: Web3Network[] = (() => {
  if (isDevelopmentMode) {
    return [KovanNetwork, MumbaiNetwork, GoerliNetwork, MainnetNetwork, PolygonNetwork, TestnetNetwork,BsctestnetNetwork];
  }
