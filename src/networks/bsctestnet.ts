...
const RPC_KEY = '';
const RPC_HTTPS_URL = `https://data-seed-prebsc-1-s1.binance.org:8545/${RPC_KEY}`;
const RPC_WSS_URL = `wss://data-seed-prebsc-1-s1.binance.org:8545/${RPC_KEY}`;

const EXPLORER_KEY = 'CAAV7ZUGEMCP6CZJES6UD65IB7CMFBA3GV';
const EXPLORER_URL = 'https://testnet.bscscan.com';
const EXPLORER_API_URL = 'https://api-testnet.bscscan.com';

export const BSCTESTNET_CHAIN_ID = 97;

export const bsctestnetConfig: NetworkConfig = {
  title: 'BarnBridge bsctestnet',
  features: {
    yieldFarming: true,
    dao: true,
    smartYield: true,
...
export const bsctestnetMetamaskChain: MetamaskAddEthereumChain = {
  chainId: toHex(BSCTESTNET_CHAIN_ID),
...
export const BsctestnetNetwork: Web3Network = {
  id: 'bsctestnet',
  meta: {
    chainId: BSCTESTNET_CHAIN_ID,
    name: 'Binance Dev (testnet)',
    logo: 'testnet-logo',
  },
  rpc: {
  ...
  metamaskChain: bsctestnetMetamaskChain,
